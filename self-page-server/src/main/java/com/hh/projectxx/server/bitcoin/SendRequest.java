...
public class SendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WalletAppKit kit = new WalletAppKit(params, new File("."), "test-wallet");
        kit.startAsync();
        kit.awaitRunning();
        ...
        Coin value = Coin.parseCoin("0.0001");

        // To which address you want to send the coins?
        // The Address class represents a Bitcoin address.
        LegacyAddress to = LegacyAddress.fromBase58(params, "mzwdVMT67VjFhb4BRdXKKDhqXjkLicN6wp");
