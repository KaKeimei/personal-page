...
public class SendTest {
    ...
    public static void main(String[] args) throws Exception {
		...
		//receiving addr:n4iwtm9DiUCgcL8VrqFKaXJR9wGhT6uVUx
        NetworkParameters params = TestNet3Params.get();
        WalletAppKit kit = new WalletAppKit(params, new File("."), "test-wallet-receive");
        kit.startAsync();
        kit.awaitRunning();

        System.out.println("wallet sync finished... ");
        ...
        Coin value = Coin.parseCoin("0.00005");

        // To which address you want to send the coins?
        // The Address class represents a Bitcoin address.
        LegacyAddress to = LegacyAddress.fromBase58(params, "n2uQma2BWLTa37wwVFnHa6xaMETRhACbEE");
        ...
        try {
			org.bitcoinj.wallet.SendRequest request = org.bitcoinj.wallet.SendRequest.to(to, value);
...
//			Wallet.SendResult result = kit.wallet().sendCoins(kit.peerGroup(), to, value);
			...
			//blocking until broadcastComplete
			Transaction transaction = result.broadcastComplete.get();

			System.out.println("tansaction broadcast complete.. tx: " + transaction.getHashAsString());
