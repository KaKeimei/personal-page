...
<@main.page title="作者登录" currentPage='photo' activeTag=11 breadCrumb="">
<style>
	.col-xs-12{
		padding:0;
	}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input style="height:44px;" type="text" class="form-control" name="username" placeholder="邮箱账号" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                            <input style="height:44px;" type="password" class="form-control" name="pwd" placeholder="密码" />
                        </div>
                    </div>
                    <div class="form-group" >
