...
<form id="myForm" action="/web/doModify" method="post" class="form-horizontal" style="">

    <div class="col-md-12">
        <div class="form-group">

            <div class="input-group">
                <select id="cate" title="cate type" class="form-control" name="cateType" >
                    <#if types??>
                        <#list types as cateType>
                            <option <#if article.cate=cateType>selected="selected"</#if> value ="${cateType.getValue()}">${cateType.desc}</option>
                        </#list>
                    </#if>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <div class="input-group">
                ...
                <input id="title" style="height:44px;" type="text" class="form-control" name="title" placeholder="文章标题" value="${article.title}"/>
            </div>
        </div>
    </div>
    <div class="col-md-12 hide">
        <div class="form-group">
            <div class="input-group">
                ...
                <input id="id" style="height:44px;" type="text" class="form-control" name="aid" placeholder="文章标题" value="#{article.id}"/>
            </div>
        </div>
    </div>
    <#--<div class="form-group" >-->
    ...
    <div class="col-md-12">
        <div class="form-group">
            <div class="input-group">
                <textarea rows="30" id="f-detail" class="form-control ckeditor" name="data" placeholder="文章内容">${article.data!}</textarea>
            </div>
        </div>
    </div>
