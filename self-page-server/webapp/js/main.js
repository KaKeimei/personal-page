;(function () {
	...
	var profileAnimate = function() {
		var profile = $('#fh5co-profile');
		if ( profile.length > 0 ) {
			...
			profile.waypoint( function( direction ) {
				...
				if( direction === 'down' && !$(this.element).hasClass('animated') ) {
					...
					setTimeout(function() {
						profile.find('.to-animate').each(function( k ) {
							var el = $(this);
	...
	var profileAnimate = function() {
	  ...
	  var careerAnimate = function() {
	      var features = $('#career-section');
	...
	var skillAnimate = function() {
	  ...
	  var educationAnimate = function() {
	      var wallets = $('#education-section');
	      if ( wallets.length > 0 ) { 
